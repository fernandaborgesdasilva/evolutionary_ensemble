...
for num_cores in $list;do 
    ...
    time python3 -u /home/covoes/fernanda/commit_d9c366c/evolutionary_ensemble/exec/pdce.py -i $mnist_dir -o output_pdce_g1_m1_$num_cores -e $num_classifiers -s $num_iterations -c $num_cores -g 1 -m 1 &> stdout_pdce_g1_m1_$num_cores.txt
    ...
    rm -rf /tmp/fernanda/commit_d9c366c/$input_file/stdout_pdce_g1_m1_$num_cores
    ...
    #echo "The mutation will be guided by the fitness"
    #time python3 -u /home/covoes/fernanda/commit_d9c366c/evolutionary_ensemble/exec/pdce.py -i $mnist_dir -o output_pdce_g0_m1_$num_cores -e $num_classifiers -s $num_iterations -c $num_cores -g 0 -m 1 &> stdout_pdce_g0_m1_$num_cores.txt
    ...
    #rm -rf /tmp/fernanda/commit_d9c366c/$input_file/stdout_pdce_g0_m1_$num_cores
    #cp /tmp/fernanda/commit_d9c366c/$input_file/pdce_fold_* /home/covoes/fernanda/commit_d9c366c/$input_file
    #rm -rf /tmp/fernanda/commit_d9c366c/$input_file/pdce_fold_*
    #echo ""
    #let iteration=$iteration+1
    ...
    #time python3 -u /home/covoes/fernanda/commit_d9c366c/evolutionary_ensemble/exec/pdce.py -i $mnist_dir -o output_pdce_g1_m0_$num_cores -e $num_classifiers -s $num_iterations -c $num_cores -g 1 -m 0 &> stdout_pdce_g1_m0_$num_cores.txt
    ...
    #rm -rf /tmp/fernanda/commit_d9c366c/$input_file/stdout_pdce_g1_m0_$num_cores
    #cp /tmp/fernanda/commit_d9c366c/$input_file/pdce_fold_* /home/covoes/fernanda/commit_d9c366c/$input_file
    #rm -rf /tmp/fernanda/commit_d9c366c/$input_file/pdce_fold_*
    #echo ""
    #let iteration=$iteration+1
    ...
    #echo "The features will not be considered as genes by the algorithm"
    #echo "The mutation will not be guided by the fitness"
    #time python3 -u /home/covoes/fernanda/commit_d9c366c/evolutionary_ensemble/exec/pdce.py -i $mnist_dir -o output_pdce_g0_m0_$num_cores -e $num_classifiers -s $num_iterations -c $num_cores -g 0 -m 0 &> stdout_pdce_g0_m0_$num_cores.txt
    ...
    #rm -rf /tmp/fernanda/commit_d9c366c/$input_file/stdout_pdce_g0_m0_$num_cores
    #cp /tmp/fernanda/commit_d9c366c/$input_file/pdce_fold_* /home/covoes/fernanda/commit_d9c366c/$input_file
    #rm -rf /tmp/fernanda/commit_d9c366c/$input_file/pdce_fold_*
    echo ""
done
