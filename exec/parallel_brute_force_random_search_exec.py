    ...
    with open(outputfile, "w") as text_file:
        ...
        for train, val in kf.split(data):
            ...
            for i in range(0, 10):
                ...
                csv_file = 'pbfec_rand_fold_' + str(fold) + '_iter_' + str(i) + '_' + str(n_cores) + '_' + time.strftime("%H_%M_%S", time.localtime(time.time())) + '.csv'
                print('\n\nIteration = ',i)
                text_file.write("\n\nIteration = %i" % (i))
                ...
                search_results = ensemble_classifier.fit(data[train], target[train], all_possible_ensembles, selected_ensemble, n_cores)
