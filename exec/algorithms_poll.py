def gen_members(dims):
    ...
    members = {
            ...
            'sklearn.neighbors.RadiusNeighborsClassifier': {'radius':[0.5, 0.7, 1.0], 'weights':['uniform', 'distance']},
            'sklearn.neighbors.NearestCentroid': {},
            'sklearn.linear_model.RidgeClassifier': {'alpha':[1.0, 10.0],'max_iter':[10, 100]},
            'sklearn.svm.SVC': {'C':[1, 100, 500, 1000],'gamma':[0.0001, 0.0005, 0.001]},
            'sklearn.svm.LinearSVC': {'C':[1, 100, 500, 1000],'max_iter':[100]},
