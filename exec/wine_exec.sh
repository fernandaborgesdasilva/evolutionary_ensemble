...
#time python3 -u /home/covoes/fernanda/commit_e40d945/evolutionary_ensemble/exec/random_search.py -i $wine_dir -o saida_rs -e $num_classifiers -s $num_iterations_rs &> output_rs.txt
...
#time python3 -u /home/covoes/fernanda/commit_e40d945/evolutionary_ensemble/exec/diversity_grid.py -i $wine_dir -o saida_dce_grid -e $num_classifiers -s $num_iterations &> output_dce_grid.txt
...
#time python3 -u /home/covoes/fernanda/commit_e40d945/evolutionary_ensemble/exec/brute_force_search_exec.py -i $wine_dir -o saida_bf -e $num_classifiers -s $num_iterations &> output_bf.txt
...
#time python3 -u /home/covoes/fernanda/commit_e40d945/evolutionary_ensemble/exec/brute_force_random_search_exec.py -i $wine_dir -o saida_bfr -e $num_classifiers -s $num_iterations &> output_bfr.txt
...
for num_cores in $list;do 
    ...
    time python3 -u /home/covoes/fernanda/commit_e40d945/evolutionary_ensemble/exec/parallel_random_search.py -i $wine_dir -o saida_prs_0_$num_cores -e $num_classifiers -s $num_iterations_rs -c $num_cores -p 0 &> output_prs_0_$num_cores.txt
    ...
    time python3 -u /home/covoes/fernanda/commit_e40d945/evolutionary_ensemble/exec/parallel_random_search.py -i $wine_dir -o saida_prs_1_$num_cores -e $num_classifiers -s $num_iterations_rs -c $num_cores -p 1 &> output_prs_1_$num_cores.txt
    ...
    time python3 -u /home/covoes/fernanda/commit_e40d945/evolutionary_ensemble/exec/parallel_diversity_grid.py -i $wine_dir -o saida_pdce_grid_$num_cores -e $num_classifiers -s $num_iterations -c $num_cores &> output_pdce_grid_$num_cores.txt
    ...
    time python3 -u /home/covoes/fernanda/commit_e40d945/evolutionary_ensemble/exec/parallel_brute_force_search_exec.py -i $wine_dir -o saida_pbf_$num_cores -e $num_classifiers -s $num_iterations -c $num_cores &> output_pbf_$num_cores.txt
    ...
    time python3 -u /home/covoes/fernanda/commit_e40d945/evolutionary_ensemble/exec/parallel_brute_force_random_search_exec.py -i $wine_dir -o saida_pbfr_$num_cores -e $num_classifiers -s $num_iterations -c $num_cores &> output_pbfr_$num_cores.txt
